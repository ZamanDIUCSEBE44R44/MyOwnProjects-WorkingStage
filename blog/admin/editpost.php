        ...
        <div class="grid_10">       
            ...
            <?php
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if ($cat == "" || $title == "" || $body == "" || $tags == "" || $author == ""  || $userid == "" ) {
                        ...
                        if (!empty($file_name)) {
                            ...
                            if ($file_size >1048567) {
                              ...
                              echo "<span class='error'>You can upload only:-".implode(', ', $permited)."</span>";
                                ...
                                //update image
                                $query = "SELECT image FROM tbl_post WHERE id ='$postid'";
                 ...
                 <form action="" method="POST" enctype="multipart/form-data">                    
                    <table class="form">                       
                        <tr>
                            ...
                            <td><input type="text" name="title" value="<?php echo $postresult['title']; ?>" class="medium" /></td>
                        </tr>                     
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><img src="<?php echo $postresult['image']; ?>" alt="" height="100px" width="200px" /></td>
                      </tr>                  
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="tags" value="<?php echo $postresult['tags']; ?>" class="medium" /></td>
                        </tr>
                        <tr>
